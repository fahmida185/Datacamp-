...
# Erik Spence
#
# This file, Generate_Recipes.py, contains code used for an RNN
# example.  It is a script which takes a trained RNN and uses it to
# generate text.  In this case it is used to generate cooking recipes.
#
